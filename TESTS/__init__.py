...
def test_1():
    dnaString = loadFile(join("DATA", "DNA", "DNA_seq_altered.txt"))
    dna = DNA(dnaString)
    rna = dna.createRNA()
    dna1 = rna.createDNA()
...
def test_2():
    dnaString_1 = loadFile(join("DATA", "DNA", "DNA_seq_altered.txt"))
    dna = DNA(dnaString_1)
    dna.writeToFile(join("DATA", "DNA", "DNA_test_2.txt"))
    dnaString_2 = loadFile(join("DATA", "DNA", "DNA_test_2.txt"))
...
def test_3():
    ...
    dna = DNA(dnaString)
    rna = dna.createRNA()
    rna.writeToFile(join("DATA", "RNA", "RNA_test_3.txt"))
    rnaString = loadFile(join("DATA", "RNA", "RNA_test_3.txt"))
...
def test_4():
    dnaString = loadFile(join("DATA", "DNA", "DNA_test_2.txt"))
    dna = DNA(dnaString)
    rnaString = loadFile(join("DATA", "RNA", "RNA_test_3.txt"))
    rna = RNA(rnaString)
    ...
    if ((rna_beginPositions == dna_beginPositions) and (rna_endPositions == dna_endPositions)):
        ...
        protein.writeToFile(join("DATA", "PROTEIN", "Protein_test4.txt"))
        builded_protein = loadFile(join("DATA", "PROTEIN", "Protein_test4.txt"))
        valid_protein = loadFile(join("DATA", "PROTEIN", "amino_acid_sequence_original.txt"))
